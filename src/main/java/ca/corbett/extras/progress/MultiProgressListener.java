 ...
 * <pre>
 * &#64;Override
 * boolean minorProgressUpdate(int majorStep, int minorStep, String message) {
...
public interface MultiProgressListener {
     ...
     */
    void progressBegins(int totalMajorSteps);
     ...
     */
    boolean majorProgressUpdate(int majorStep, int totalMinorSteps, String message);
     ...
     * @return Return true to continue processing, or false if you wish to cancel the operation.
     */
    boolean progressError(String errorSource, String errorDetails);
