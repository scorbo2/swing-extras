...
public abstract class AbstractProperty {
     ...
     * then you can override this method to return false. This is currently used only by the unit tests,
    ...
    public boolean isAllowsUserInput() {
        return true; // default is true, so most implementing classes don't need to worry about it.
    }
