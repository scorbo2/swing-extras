...
public class ColorProperty extends AbstractProperty {
    ...
    protected FormField generateFormFieldImpl() {
        ...
        //@formatter:off
        switch (colorType) {
            case SOLID:    field = new GradientColorField(propertyLabel, color);    break;
            case GRADIENT: field = new GradientColorField(propertyLabel, gradient); break;
    ...
    public void loadFromFormField(FormField field) {
        if (field.getIdentifier() == null || !field.getIdentifier()
                                                   .equals(fullyQualifiedName) || !(field instanceof GradientColorField)) {
        ...
        //@formatter:off
        switch (colorType) {
            case SOLID:    setColor(cField.getColor()); break;
