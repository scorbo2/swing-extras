...
public class WaveformPanelConfigPanel extends ConfigPanel<AudioWaveformPanel> {
  ...
  public void load(AudioWaveformPanel obj) {
    switch (obj.getControlPanelSize()) {
      case XSMALL:
        controlSizeCombo.setSelectedIndex(0);
        break;
      case SMALL:
        controlSizeCombo.setSelectedIndex(1);
        break;
      case NORMAL:
        controlSizeCombo.setSelectedIndex(2);
        break;
      case LARGE:
        controlSizeCombo.setSelectedIndex(3);
        break;
      case XLARGE:
        controlSizeCombo.setSelectedIndex(4);
        break;
    }

    switch (obj.getControlPanelPosition()) {
      case TOP_LEFT:
        controlPositionCombo.setSelectedIndex(0);
        break;
      case TOP_CENTER:
        controlPositionCombo.setSelectedIndex(1);
        break;
      case TOP_RIGHT:
        controlPositionCombo.setSelectedIndex(2);
        break;
      case SIDE_EDGES:
        controlPositionCombo.setSelectedIndex(3);
        break;
      case BOTTOM_LEFT:
        controlPositionCombo.setSelectedIndex(4);
        break;
      case BOTTOM_CENTER:
        controlPositionCombo.setSelectedIndex(5);
        break;
      case BOTTOM_RIGHT:
        controlPositionCombo.setSelectedIndex(6);
        break;
      case HIDDEN:
        controlPositionCombo.setSelectedIndex(7);
        break;
    }
  ...
  private void updateControlSize(AudioWaveformPanel panel) {
    if (panel != null) {
      switch (controlSizeCombo.getSelectedIndex()) {
        case 0:
          panel.setControlPanelSize(AudioWaveformPanel.ControlPanelSize.XSMALL);
          break;
        case 1:
          panel.setControlPanelSize(AudioWaveformPanel.ControlPanelSize.SMALL);
          break;
        case 2:
          panel.setControlPanelSize(AudioWaveformPanel.ControlPanelSize.NORMAL);
          break;
        case 3:
          panel.setControlPanelSize(AudioWaveformPanel.ControlPanelSize.LARGE);
          break;
        case 4:
          panel.setControlPanelSize(AudioWaveformPanel.ControlPanelSize.XLARGE);
          break;
      }
      notifyChangeListeners();
    }
  ...
  private void updateControlPosition(AudioWaveformPanel panel) {
    if (panel != null) {
      switch (controlPositionCombo.getSelectedIndex()) {
        case 0:
          panel.setControlPanelPosition(AudioWaveformPanel.ControlPanelPosition.TOP_LEFT);
          break;
        case 1:
          panel.setControlPanelPosition(AudioWaveformPanel.ControlPanelPosition.TOP_CENTER);
          break;
        case 2:
          panel.setControlPanelPosition(AudioWaveformPanel.ControlPanelPosition.TOP_RIGHT);
          break;
        case 3:
          panel.setControlPanelPosition(AudioWaveformPanel.ControlPanelPosition.SIDE_EDGES);
          break;
        case 4:
          panel.setControlPanelPosition(AudioWaveformPanel.ControlPanelPosition.BOTTOM_LEFT);
          break;
        case 5:
          panel.setControlPanelPosition(AudioWaveformPanel.ControlPanelPosition.BOTTOM_CENTER);
          break;
        case 6:
          panel.setControlPanelPosition(AudioWaveformPanel.ControlPanelPosition.BOTTOM_RIGHT);
          break;
        case 7:
          panel.setControlPanelPosition(AudioWaveformPanel.ControlPanelPosition.HIDDEN);
          break;
      }
      notifyChangeListeners();
    }
